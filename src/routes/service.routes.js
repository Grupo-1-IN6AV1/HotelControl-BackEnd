...
//Admin Hotel//
api.post('/createService', [mdAuth.ensureAuth, mdAuth.isAdminHotel], serviceController.saveService);
api.get('/getService/:id', [mdAuth.ensureAuth, mdAuth.isAdminHotel], serviceController.getService);
api.get('/getServices', [mdAuth.ensureAuth, mdAuth.isAdminHotel], serviceController.getServices);
